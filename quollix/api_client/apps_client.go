...
func (c *QuollixAppsClient) UpdateSecret(appId, name, value string) error {
	_, err := c.quollix.Parent.DoRequest(api.Paths.BackendAppSecretUpdate, api.AppSecretUpdateRequest{
		AppId: appId,
		Name:  name,
		Value: value,
	})
